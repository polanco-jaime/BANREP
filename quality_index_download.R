...
#Provider=MSOLAP.8;Password=u4_gu41n14;Persist Security Info=True;User ID=sispro.local\UA_Guainia;Data Source=cubos.sispro.gov.co;Update Isolation Level=2;
